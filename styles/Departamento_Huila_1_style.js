...
var style_Departamento_Huila_1 = function(feature, resolution){
    ...
    var labelText = ""; 
    var value = feature.get("7.Huila-Huila_ Área_Sembrada_(ha)");
    ...
    if (value >= 0.000000 && value <= 0.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.000000 && value <= 85.555099) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 85.555099 && value <= 187.794857) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 187.794857 && value <= 326.232890) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 326.232890 && value <= 1063.250468) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1063.250468 && value <= 2880.589250) {
            style = [ new ol.style.Style({
